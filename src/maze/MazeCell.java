...
public class MazeCell {
	 ...
	 * @param row The row number represent this cell.
	 * @param col The col number represent this cell.
	 */
	...
	/**
	 * Use this function whenever you want to randomly pick one of the neighbors
	 * @return - random choice of one of the neighbors.
	 */
	public MazeCell getRandomNeighbor() {
		MazeCell[] neibors = getNeighbors();
		if (neibors != null) {
			return neibors[generator.nextInt(neibors.length)];
		} else {
			return null;
		}
	}
